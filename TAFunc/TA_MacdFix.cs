...
namespace TALibraryInCSharp
     ...
     { 
        ...
        public static RetCode MacdFix(int startIdx, int endIdx, float[] inReal, int optInSignalPeriod, ref int outBegIdx, ref int outNBElement, double[] outMACD, double[] outMACDSignal, double[] outMACDHist)
        {
            if (startIdx < 0)
            {
                return RetCode.OutOfRangeStartIndex;
