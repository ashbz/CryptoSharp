...
namespace TALibraryInCSharp
     ...
     { 
        ...
        public static RetCode MovingAverageVariablePeriod(int startIdx, int endIdx, float[] inReal, float[] inPeriods, int optInMinPeriod, int optInMaxPeriod, MAType optInMAType, ref int outBegIdx, ref int outNBElement, double[] outReal)
        {
            int i;
            int tempInt = 0;
            if (startIdx < 0)
