...
namespace TALibraryInCSharp
     ...
     { 
        ...
        public static RetCode StdDev(int startIdx, int endIdx, float[] inReal, int optInTimePeriod, double optInNbDev, ref int outBegIdx, ref int outNBElement, double[] outReal)
        {
            int i;
            double tempReal;
            if (startIdx < 0)
