...
namespace TALibraryInCSharp
     ...
     { 
        ...
        public static RetCode LinearRegIntercept(int startIdx, int endIdx, float[] inReal, int optInTimePeriod, ref int outBegIdx, ref int outNBElement, double[] outReal)
        {
            if (startIdx < 0)
            {
                return RetCode.OutOfRangeStartIndex;
