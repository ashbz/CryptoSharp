...
namespace TALibraryInCSharp
     ...
     { 
        ...
        public static RetCode Mfi(int startIdx, int endIdx, float[] inHigh, float[] inLow, float[] inClose, float[] inVolume, int optInTimePeriod, ref int outBegIdx, ref int outNBElement, double[] outReal)
        {
            int mflow_Idx = 0;
            int maxIdx_mflow = 0x31;
            if (startIdx < 0)
