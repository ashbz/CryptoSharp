...
namespace TALibraryInCSharp
     ...
     { 
        ...
        public static RetCode Stoch(int startIdx, int endIdx, float[] inHigh, float[] inLow, float[] inClose, int optInFastK_Period, int optInSlowK_Period, MAType optInSlowK_MAType, int optInSlowD_Period, MAType optInSlowD_MAType, ref int outBegIdx, ref int outNBElement, double[] outSlowK, double[] outSlowD)
        {
            if (startIdx < 0)
            {
                return RetCode.OutOfRangeStartIndex;
