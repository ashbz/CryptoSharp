...
namespace TALibraryInCSharp
     ...
     { 
        ...
        public static RetCode Beta(int startIdx, int endIdx, float[] inReal0, float[] inReal1, int optInTimePeriod, ref int outBegIdx, ref int outNBElement, double[] outReal)
        {
            double x;
            double y;
            double S_xx = 0.0;
