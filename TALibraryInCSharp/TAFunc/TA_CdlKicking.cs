...
namespace TALibraryInCSharp
     ...
     { 
        ...
        public static RetCode CdlKicking(int startIdx, int endIdx, float[] inOpen, float[] inHigh, float[] inLow, float[] inClose, ref int outBegIdx, ref int outNBElement, int[] outInteger)
        {
            int totIdx;
            int num68;
            double[] ShadowVeryShortPeriodTotal = new double[2];
