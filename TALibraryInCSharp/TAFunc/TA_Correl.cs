...
namespace TALibraryInCSharp
     ...
     { 
        ...
        public static RetCode Correl(int startIdx, int endIdx, float[] inReal0, float[] inReal1, int optInTimePeriod, ref int outBegIdx, ref int outNBElement, double[] outReal)
        {
            double y;
            double x;
            if (startIdx < 0)
