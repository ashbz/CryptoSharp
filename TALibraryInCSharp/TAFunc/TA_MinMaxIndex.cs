...
namespace TALibraryInCSharp
     ...
     { 
        ...
        public static RetCode MinMaxIndex(int startIdx, int endIdx, float[] inReal, int optInTimePeriod, ref int outBegIdx, ref int outNBElement, int[] outMinIdx, int[] outMaxIdx)
        {
            int i;
            if (startIdx < 0)
            {
