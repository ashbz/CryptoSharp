...
namespace TALibraryInCSharp
     ...
     { 
        ...
        public static RetCode Variance(int startIdx, int endIdx, float[] inReal, int optInTimePeriod, double optInNbDev, ref int outBegIdx, ref int outNBElement, double[] outReal)
        {
            if (startIdx < 0)
            {
                return RetCode.OutOfRangeStartIndex;
