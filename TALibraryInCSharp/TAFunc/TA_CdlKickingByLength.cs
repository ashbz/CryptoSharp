...
namespace TALibraryInCSharp
     ...
     { 
        ...
        public static RetCode CdlKickingByLength(int startIdx, int endIdx, float[] inOpen, float[] inHigh, float[] inLow, float[] inClose, ref int outBegIdx, ref int outNBElement, int[] outInteger)
        {
            int totIdx;
            int num70;
            double[] ShadowVeryShortPeriodTotal = new double[2];
