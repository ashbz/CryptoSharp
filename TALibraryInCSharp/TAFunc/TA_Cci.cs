...
namespace TALibraryInCSharp
     ...
     { 
        ...
        public static RetCode Cci(int startIdx, int endIdx, float[] inHigh, float[] inLow, float[] inClose, int optInTimePeriod, ref int outBegIdx, ref int outNBElement, double[] outReal)
        {
            int circBuffer_Idx = 0;
            int maxIdx_circBuffer = 0x1d;
            if (startIdx < 0)
