...
namespace TALibraryInCSharp
     ...
     { 
        ...
        public static RetCode PlusDM(int startIdx, int endIdx, float[] inHigh, float[] inLow, int optInTimePeriod, ref int outBegIdx, ref int outNBElement, double[] outReal)
        {
            double tempReal;
            int today;
            double diffP;
