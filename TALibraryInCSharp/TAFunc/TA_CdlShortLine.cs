...
namespace TALibraryInCSharp
     ...
     { 
        ...
        public static RetCode CdlShortLine(int startIdx, int endIdx, float[] inOpen, float[] inHigh, float[] inLow, float[] inClose, ref int outBegIdx, ref int outNBElement, int[] outInteger)
        {
            float num5;
            float num10;
            float num15;
        ...
        Label_024A:
            ...
            if (Math.Abs((float)(inClose[i] - inOpen[i])) < ((Globals.candleSettings[2].factor * num44) / num38))
            {
                double num30;
                double num36;
                float num37;
