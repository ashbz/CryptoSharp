...
namespace TALibraryInCSharp
     ...
     { 
        ...
        public static RetCode AroonOsc(int startIdx, int endIdx, float[] inHigh, float[] inLow, int optInTimePeriod, ref int outBegIdx, ref int outNBElement, double[] outReal)
        {
            int i;
            double aroon;
            if (startIdx < 0)
