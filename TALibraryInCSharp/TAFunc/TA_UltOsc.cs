...
namespace TALibraryInCSharp
     ...
     { 
        ...
        public static RetCode UltOsc(int startIdx, int endIdx, float[] inHigh, float[] inLow, float[] inClose, int optInTimePeriod1, int optInTimePeriod2, int optInTimePeriod3, ref int outBegIdx, ref int outNBElement, double[] outReal)
        {
            int outIdx;
            int[] usedFlag = new int[3];
            int[] periods = new int[3];
